...
class HomeViewController: UIViewController {
    ...
    func createHeaderButton(title: String, imageName: String, target: Any?, action: Selector) -> UIButton {
        ...
        button.setImage(UIImage.fromPlugin(named: imageName), for: .normal)
    ...
    lazy var avatarButton: UIButton = {
        ...
        avatarButton.setupCommonCustomAlert([
            .init(title: localizeStrings("Profile"), image: UIImage.fromPlugin(named: "profile"), style: .default, handler: { _ in
                self.onClickProfile()
            }),
            .init(title: localizeStrings("Setting"), image: UIImage.fromPlugin(named: "setting"), style: .default, handler: { _ in
                self.onClickSetting()
            }),
            .cancel,
    ...
    lazy var historyButton: UIButton = {
        ...
        button.setTraitRelatedBlock { v in
            let normalImage = UIImage.fromPlugin(named: "history")?.tintColor(.color(type: .text).resolvedColor(with: v.traitCollection))
            let selectedImage = UIImage.fromPlugin(named: "history")?.tintColor(.color(type: .primary).resolvedColor(with: v.traitCollection))
    ...
    lazy var tableView: UITableView = {
        ...
        table.register(.init(nibName: String(describing: RoomTableViewCell.self), bundle: AgoraNativePlugin.pluginBundle), forCellReuseIdentifier: roomTableViewCellIdentifier)
...
extension HomeViewController: DZNEmptyDataSetSource, DZNEmptyDataSetDelegate {
    ...
    func image(forEmptyDataSet _: UIScrollView) -> UIImage? {
        UIImage(named: "room_empty", in: AgoraNativePlugin.pluginBundle, compatibleWith: traitCollection)
    }
