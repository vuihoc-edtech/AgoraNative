...
class CloudStorageInClassViewController: CloudStorageDisplayViewController {
    ...
    override func traitCollectionDidChange(_ previousTraitCollection: UITraitCollection?) {
        ...
        addButton.setImage(UIImage.fromPlugin(named: "storage_add_small"), for: .normal)
    }
    ...
    func setupAddButton() {
        if #available(iOS 14.0, *) {
            let actions = UploadType.allCases.map { type in
                UIAction(title: type.title, image: UIImage.fromPlugin(named: type.imageName)?.withTintColor(.color(type: .text, .strong), renderingMode: .alwaysOriginal)) { _ in
    ...
    lazy var backItem: UIButton = {
        ...
        backItem.setImage(UIImage.fromPlugin(named: "arrowLeft"), for: .normal)
    ...
    lazy var topView: UIView = {
        ...
        if let navi = navigationController, navi.viewControllers.count > 1 {
            ...
            let leftIcon = UIImageView(image: UIImage.fromPlugin(named: "classroom_cloud"))
    ...
    lazy var addButton: UIButton = {
        ...
        button.setImage(UIImage.fromPlugin(named: "storage_add_small"), for: .normal)
        return button
    }()
