...
import io.vuihoc.agora_native.databinding.LayoutUserWindowBinding
...
class UserWindowLayout @JvmOverloads constructor(
    ...
    init {
        ...
        binding.switchCamera.setImageDrawable(io.vuihoc.agora_native.ui.view.FlatDrawables.createCameraDrawable(context))

        binding.switchMic.setOnClickListener {
            onUserWindowListener?.onSwitchMic(roomUser, !binding.switchMic.isSelected)
        }
        binding.switchMic.setImageDrawable(io.vuihoc.agora_native.ui.view.FlatDrawables.createMicDrawable(context))
