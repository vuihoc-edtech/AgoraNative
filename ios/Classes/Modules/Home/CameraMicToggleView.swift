...
class CameraMicToggleView: UIView {
    ...
    lazy var cameraButton: UIButton = {
        ...
        button.setImage(UIImage.fromPlugin(named: "common_camera_on")?.tintColor(.color(type: .primary)), for: .selected)
        button.setImage(UIImage.fromPlugin(named: "common_camera_off")?.tintColor(.color(type: .danger)), for: .normal)
    ...
    lazy var microphoneButton: UIButton = {
        let button = UIButton(type: .custom)
        button.setImage(UIImage.fromPlugin(named: "common_mic_on")?.tintColor(.color(type: .primary)), for: .selected)
        button.setImage(UIImage.fromPlugin(named: "common_mic_off")?.tintColor(.color(type: .danger)), for: .normal)
        button.addTarget(self, action: #selector(onButtonClick(_:)), for: .touchUpInside)
        return button
    }()
