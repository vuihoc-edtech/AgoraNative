...
enum ClassroomNetworkStatus {
    ...
    var image: UIImage? {
        switch self {
        case .great:
            return UIImage.fromPlugin(named: "network-great")
        case .good:
            return UIImage.fromPlugin(named: "network-good")
        case .bad:
            return UIImage.fromPlugin(named: "network-bad")
        }
    }
}
...
class ClassroomStatusBar: UIView {
    ...
    lazy var onStageStatusButton: UIButton = {
        ...
        btn.setImage(UIImage.fromPlugin(named: "statusbar_onstage_user"), for: .normal)
