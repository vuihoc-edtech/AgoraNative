...
class SettingViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func updateItems() {
        items = [
            ItemSection(title: localizeStrings("Security"), items:
                [.init(image: UIImage.fromPlugin(named: "security")!,
            ...
            ItemSection(title: localizeStrings("Preferences"), items:
                [.init(image: UIImage.fromPlugin(named: "language")!,
            ...
            ItemSection(title: localizeStrings("Privacy"), items:
                [.init(image: UIImage.fromPlugin(named: "personal_collect")!,
                       title: localizeStrings("PersonalInfoCollect"),
                       detail: "",
                       targetAction: (self, #selector(onClickInfoCollect))),
                 .init(image: UIImage.fromPlugin(named: "third_share")!,
        ...
        if let collectSpecialData {
            i.append(.init(image: UIImage.fromPlugin(named: "videoCollect")!, title: localizeStrings("VideoDataCollecting"), detail: collectSpecialData, targetAction: (self, #selector(onUpdateVideoDataCollection))))
    ...
    lazy var logoutButton: UIButton = {
        ...
        button.setImage(UIImage.fromPlugin(named: "logout"), for: .normal)
    ...
    lazy var tableView: UITableView = {
        ...
        view.register(UINib(nibName: String(describing: SettingTableViewCell.self), bundle: AgoraNativePlugin.pluginBundle), forCellReuseIdentifier: cellIdentifier)
