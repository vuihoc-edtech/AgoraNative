...
class PasswordTextfield: BottomLineTextfield {
    ...
    override func setupViews() {
        ...
        let leftIcon = UIImageView(image: UIImage.fromPlugin(named: "password_icon"))
    ...
    private func syncSecretMode() {
        secretModeButton.setImage(UIImage.fromPlugin(named: isSecureTextEntry ? "secure_keyboard" : "no_secure_keyboard"), for: .normal)
    }
    ...
    lazy var secretModeButton: UIButton = {
        ...
        btn.setImage(UIImage.fromPlugin(named: "secure_keyboard"), for: .normal)
