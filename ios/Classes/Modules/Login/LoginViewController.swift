...
class LoginViewController: UIViewController {
    ...
    // Regular
    @IBOutlet weak var loginRegularBg: LoginBackgroundView!
    @IBOutlet weak var regularLogoStackView: UIStackView!
    @IBOutlet weak var flatLabel: UILabel!

    // Compact
    @IBOutlet weak var compactBackgroundLogoView: CompactLoginBackgroundView!

    // Common
    @IBOutlet weak var authInputStackView: UIStackView!
    @IBOutlet weak var loginTypeToggleButton: UIButton!
    @IBOutlet weak var forgetPasswordButton: UIButton!
    @IBOutlet weak var loginButton: FlatGeneralCrossButton!
    @IBOutlet weak var registerButton: SpringButton!
    @IBOutlet weak var tipsLabel: UILabel!
    @IBOutlet weak var thirdPartLoginStackView: UIStackView!
