...
class HistoryViewController: UIViewController {
    ...
    lazy var tableView: UITableView = {
        ...
        table.register(.init(nibName: String(describing: RoomTableViewCell.self), bundle: AgoraNativePlugin.pluginBundle), forCellReuseIdentifier: historyTableViewCellIdentifier)
...
extension HistoryViewController: DZNEmptyDataSetSource, DZNEmptyDataSetDelegate {
    ...
    func image(forEmptyDataSet _: UIScrollView) -> UIImage? {
        UIImage(named: "history_empty", in: AgoraNativePlugin.pluginBundle, compatibleWith: traitCollection)
    }
