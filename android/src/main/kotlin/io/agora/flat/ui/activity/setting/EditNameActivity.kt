...
class EditNameActivity : BaseComposeActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val viewModel: EditNameViewModel by viewModels()
        setContent {
            EditNameScreen(onFinish = { finish() }, viewModel = viewModel)
        }
    }
}

@Composable
private fun EditNameScreen(onFinish: () -> Unit, viewModel: EditNameViewModel) {
