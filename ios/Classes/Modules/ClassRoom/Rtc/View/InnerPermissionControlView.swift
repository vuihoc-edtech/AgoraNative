...
class InnerPermissionControlView: UIView {
    ...
    lazy var cameraOnImage = UIImage.fromPlugin(named: "camera_on")!
    lazy var cameraOffImage = UIImage.fromPlugin(named: "camera_off")!

    lazy var whiteboardOnImage = UIImage.fromPlugin(named: "whiteboard_permission_on")!
    lazy var whiteboardOffImage = UIImage.fromPlugin(named: "whiteboard_permission_off")!

    lazy var micOnImage = UIImage.fromPlugin(named: "mic_on")!
    lazy var micOffImage = UIImage.fromPlugin(named: "mic_off")!
    ...
    lazy var rewardsButton: UIButton = {
        let btn = UIButton(type: .custom)
        btn.setImage(UIImage.fromPlugin(named: "rewards"), for: .normal)
    ...
    lazy var muteAllButton: UIButton = {
        let btn = UIButton(type: .custom)
        btn.setImage(UIImage.fromPlugin(named: "mute_all"), for: .normal)
        btn.tintColor = .color(light: .grey6, dark: .grey4)
    ...
    lazy var resetLayoutButton: UIButton = {
        let btn = UIButton(type: .custom)
        btn.setImage(UIImage.fromPlugin(named: "layout_reset"), for: .normal)
        btn.tintColor = .color(light: .grey6, dark: .grey4)
